...
def load_dataset(train_size, batch_size=512, random_state=0):
    ...
    return train_ds, vald_ds, test_ds, X_train.shape[1], C, fe
...
def main(argv):
    ...
    if args.save_filename:
        ...
        path_filename = saved_model_path + 'ifeNet_adult.h5'
    ...
    train_ds, vald_ds, test_ds, n_features, n_classes, fe_train = load_dataset(train_size=train_size, batch_size=batch_size, random_state=random_state)
